...
echo You will now install Python 3.9 from the Microsoft Store.
echo I will open the Microsoft Store for you. Install Python 3.9 :-)
...
echo Alternatively you can also use the regular Python 3.9.2 installer if you so wish. In that case skip this step.
